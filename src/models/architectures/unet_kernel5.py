"""UNet architecture with 5x5 kernels instead of 3x3."""
...
@register_model('UNetKernel5')
class UNetKernel5(nn.Module):
    """
    UNet architecture with 5x5 kernels instead of standard 3x3.
    
    Larger kernels provide a larger receptive field per layer, potentially
    capturing more spatial context. This comes at the cost of more parameters
    and computations.
    """
